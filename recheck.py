...
def main():
    ...
    parser.add_argument("--ids", type=int, nargs="+", required=True, help="List of app IDs to re-run")
    ...
    logger.info(f"Re-running research for {len(apps_to_run)} apps: {[a['id'] for a in apps_to_run]}")
